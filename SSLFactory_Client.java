...
public class SSLFactory_Client {
    public static void main(String[] args){
       ...
       if(args.length!=3){
		   ...
		   System.out.println("Defaulting to google.com:443");
       }else{
           hostname = args[0];
	   ...
	   System.out.println("Using cacerts " + filePath)

       SSLFactory_Client sclient = new SSLFactory_Client();
       SSLContext sslContext = sclient.createSSLContext(filePath);
       try {
    ...
    private SSLContext createSSLContext(String cacertsPath){
       try{
